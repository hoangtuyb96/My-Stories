...
ActiveRecord::Schema.define(version: 20170825013049) do
  ...
  create_table "clone_stories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "story_id"
    t.integer "cloned_story_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cloned_story_id"], name: "index_clone_stories_on_cloned_story_id"
    t.index ["story_id"], name: "index_clone_stories_on_story_id"
    t.index ["user_id", "story_id"], name: "index_clone_stories_on_user_id_and_story_id"
    t.index ["user_id"], name: "index_clone_stories_on_user_id"
  end
  ...
  create_table "relationship_stories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["story_id"], name: "index_relationship_stories_on_story_id"
    t.index ["user_id", "story_id"], name: "index_relationship_stories_on_user_id_and_story_id", unique: true
    t.index ["user_id"], name: "index_relationship_stories_on_user_id"
  end
